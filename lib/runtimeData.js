const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Dvoechnik_vk_16.30_Web_VKontakte.loader.js",
        dataURL: "bin/Dvoechnik_vk_16.30_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/Dvoechnik_vk_16.30_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Dvoechnik_vk_16.30_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
